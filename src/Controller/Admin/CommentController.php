...
final class CommentController extends AbstractController
{
    ...
    public function index(Request $request, CommentRepository $commentRepository): Response
    {
        ...
        return $this->render('postandcomment/admin/comment/index.html.twig', [
            'comments' => $paginator,
            'currentPage' => $page,
    ...
    public function postComments(Request $request, Post $post, CommentRepository $commentRepository): Response
    {
        ...
        return $this->render('postandcomment/admin/comment/post_comments.html.twig', [
            'post' => $post,
            'comments' => $paginator,
            'currentPage' => $page,
            'totalPages' => $totalPages,
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, Post $post): Response
    {
        ...
        return $this->render('postandcomment/admin/comment/new.html.twig', [
            'comment' => $comment,
            'post' => $post,
            'form' => $form,
        ]);
    ...
    public function edit(Request $request, Comment $comment, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('postandcomment/admin/comment/edit.html.twig', [
            'comment' => $comment,
            'form' => $form,
    ...
    {
        return $this->render('postandcomment/admin/comment/show.html.twig', [
            'comment' => $comment,
        ]);
    }
